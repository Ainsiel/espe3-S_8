...
"""
            ...
            # 3. Create test-report.md (EventPass)
            test_report_content = f"""# Reporte de Pruebas de Software (Test Report - EventPass)
...
"""
            ...
            # 4. Create validation-report.md (EventPass)
            validation_report_content = f"""# Reporte de Validación Final (Validation Report - EventPass)
